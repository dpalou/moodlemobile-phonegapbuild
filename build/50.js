...
// EXTERNAL MODULE: ./src/classes/utils/url.ts
var utils_url = __webpack_require__(1621);
    ...
    CoreLoginSitePage.prototype.connect = function (e, url) {
        ...
        if (siteData) {
            ...
            this.sitesProvider.checkSite(url)
                ...
                var domain = utils_url["a" /* CoreUrl */].guessMoodleDomain(url);
...
var auto_focus = __webpack_require__(379);
...
var searchbar_ngfactory = __webpack_require__(1579);
